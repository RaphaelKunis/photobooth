<?php
/* edited by rk1
	added possibility to turn off galery by config param (use_gallery)
	added possibility to set countdown timer by config param (cntdwn_time)
*/
...
<head>
	...
	<script type="text/javascript">
		...
		var gallery_newest_first = <?php echo ($config['gallery']['newest_first']) ? 'true' : 'false'; ?>;
                // rk1
		var cntdwn_time = <?php echo ($config['cntdwn_time']); ?>;  // control countdown timer with config, needed in core.js   
		var use_qr = <?php echo $config['use_qr'] ? ("true") : ("false"); ?>;            // control qr-image creation, needed in core.js, !! true -> 1, false -> 0 !!
		var use_gallery = <?php echo $config['use_gallery'] ? ("true") : ("false"); ?>;  // control add image to gallery, needed in core.js !! true -> 1, false -> 0 !!              
	</script>
</head>
<body class="deselect">
	<div id="wrapper">
		...
		<div class="stages" id="start">
                        <?php if($config['use_gallery']){echo '<a class="gallery btn" href="#"><i class="fa fa-th"></i> <span data-l10n="gallery"></span></a>'; } ?>
			<div class="blurred">
			</div>
			<div class="inner">
		...
		<div class="stages" id="result">
			...
			<div class="resultInner hidden">
                        <?php if($config['use_gallery']){echo '<a href="#" class="btn gallery"><i class="fa fa-th"></i> <span data-l10n="gallery"></span></a>'; } ?>
